...
module.exports = {
  ...
  output: {
    ...
    // are generated at runtime, and links to these files are sent down to the browser.
    // The browser then sends requests for those chunks in parallel, effectively
    // letting us send down more data faster.
